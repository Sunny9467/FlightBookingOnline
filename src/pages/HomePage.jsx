...
export default function HomePage() {
    ...
    return (
        ...
        <div>
                            ...
                            {tripType === "roundtrip" && (
                                <div className="border rounded-xl p-3 hover:shadow-md transition">
                                    ...
                                    <input
                                        ...
                                        className="w-full   outline-none font-semibold cursor-pointer"
                                    />
                                </div>
                            )}
            ...
            {/* Features Section */}
            <h2 className="text-center text-3xl py-4 mb-2">Our Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 mt-2 gap-4 p-6">

                {
                    Features.map((item, index) => {
                        return <div key={index} className="bg-white rounded-xl p-6 text-center shadow-md hover:shadow-xl transition hover:-translate-y-2">
